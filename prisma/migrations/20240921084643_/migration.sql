...
CREATE TABLE "_GroupToLesson" (
    "A" TEXT NOT NULL,
    "B" INTEGER NOT NULL,
    CONSTRAINT "_GroupToLesson_A_fkey" FOREIGN KEY ("A") REFERENCES "Group" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "_GroupToLesson_B_fkey" FOREIGN KEY ("B") REFERENCES "Lesson" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
